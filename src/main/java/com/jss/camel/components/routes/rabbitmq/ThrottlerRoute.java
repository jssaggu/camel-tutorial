...
public class ThrottlerRoute extends RouteBuilder {
    ...
    public static final String RABBIT_URI = "rabbitmq:" + EXCHANGE_IOT + "?queue=%s&routingKey=%s&autoDelete=false&autoAck=false";
    ...
    public void configure() throws Exception {
        ...
        from("timer:iot?period=10")
                .process(p -> {
                    ...
                    System.out.print("\rSent [" + sent.get() + "] Received [" + received + "]");
                })
