...
public class CreditService {
    ...
    public void makePayment(Exchange exchange){
        ...
        System.out.println("Taking Payment for Order ID: [" + id + "] " +
        ...
        System.out.println("Payment made for Order ID: [" + id + "] " +
    ...
    public void refundPayment(Exchange exchange){
        ...
        System.out.println("Returning Payment for Order ID: [" + id + "] " +
        ...
        System.out.println("Payment returned for Order ID: [" + id + "] " +
